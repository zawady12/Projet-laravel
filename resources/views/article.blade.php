...
<inPUt type="text" class="form-control"  name="CodeA" rows="3" placeholder="saisir le code">
<span class="text-danger">@error('CodeA'){{$message}}@enderror</span>

</div>
<div class="mb-3">
<label for="designA" class="form-label">Designation</label>
<inPUt type="text" class="form-control"  name="designA" rows="3" placeholder="">
<span class="text-danger">@error('designA'){{$message}}@enderror</span>

</div>
<div class="mb-3">
<label for="PU" class="form-label">PU</label>
<inPUt type="text" class="form-control"  name="PU" rows="3" placeholder="">
